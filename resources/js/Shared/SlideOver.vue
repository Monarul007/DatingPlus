  ...
  <TransitionRoot as="template" :show="open">
    <Dialog as="div" class="fixed inset-0 overflow-hidden" @close="open = false">
      <div class="absolute inset-0 overflow-hidden">
        ...
        <div class="animate-fade-in-left pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10">
...
import { XIcon, FolderOpenIcon } from '@heroicons/vue/outline'
